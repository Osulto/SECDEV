...
public class Register extends javax.swing.JPanel {
    ...
    private void registerBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerBtnActionPerformed
        // Get passwords as character arrays for better security
    char[] password = passwordFld.getPassword();
    char[] confPassword = confpassFld.getPassword();
    
    // Pass the arrays to the registerAction method
    // IMPORTANT: You will need to update the registerAction method in the Frame.java
    // file to accept char[] instead of String for the password fields.
     frame.registerAction(usernameFld.getText(), password, confPassword);

    // Clear the arrays from memory immediately after use
    java.util.Arrays.fill(password, ' ');
    java.util.Arrays.fill(confPassword, ' ');
